...
func TestRunEndTurnTransitionsToDone(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "Test end_turn", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRunWaitingTransitionsToWaiting(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "Test waiting", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRunIsErrorTransitionsToFailed(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "Test is_error", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRunContainerErrorTransitionsToFailed(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "Test container error", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRunMaxTokensAutoContinues(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "Test max_tokens auto-continue", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRunWorktreeSetupFailureTransitionsToFailed(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "Worktree fail task", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRunEndTurnRecordsResult(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "Result recording test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSyncWorktreesAlreadyUpToDate(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "sync up-to-date test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSyncWorktreesBehindMain(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "sync behind test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSyncWorktreesNonGitWorkspaceSkipped(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "non-git sync test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSyncWorktreesNoWorktreePaths(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "no worktrees sync test", 5)
	if err != nil {
		t.Fatal(err)
	}
	if err := s.UpdateTaskStatus(ctx, task.ID, "waiting"); err != nil {
...
func TestFailSync(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "fail sync test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestFailSyncRecordsErrorEvent(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "failSync event test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRunWithPreexistingWorktrees(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "preexisting worktrees test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRunUsageAccumulation(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "Usage test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSyncWorktreesPrevStatusRestored(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "status restore test", 5)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSyncWorktreesBehindMainDirtyWorktree(t *testing.T) {
	...
	task, err := s.CreateTask(ctx, "dirty stash sync test", 5)
	if err != nil {
		t.Fatal(err)
	}
